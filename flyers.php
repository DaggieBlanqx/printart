...
//echo "Order Number: #".$OrderNumber."<hr>Delivery Date : ".$DeliveryDate."<hr>".$OrderDetails;
  ...
  $OrderSummary = "Flyers &nbsp; >>>Height :".$Height."&nbsp; Quantity :".$Quantity;
...
<form action="#" method="POST" enctype="multipart/form-data">
  ...
  <br>
  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input" placeholder="Datew" name="DeliveryDate" type="date" id="width">
  ...
  *Please provide us with as much detail as possible for your project so that we can give you the best possible quote/proposal.Enter the projects details below:<br>
  ...
  <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored mdl-js-ripple-effect mdl-button--accent" name="Flyers_Order">SUBMIT ORDER</button>
</form>
</div>
	</div>
