...
if (isset($_POST['BizCards_Order'])) {
  ...
  $OrderSummary = "Business Cards &nbsp; >>>Height :".$Height."&nbsp; Quantity :".$Quantity;
...
<div class="mdl-grid">
  <div class="mdl-cell mdl-cell--4-col mdl-cell--hide-phone">
    <?php @include("base_includes/business_cards_pricing.php");?>
  </div>
  <div class="mdl-cell mdl-cell--4-col mdl-cell--12-col-phone">
    ...
    <div class="blanqxLegend">
     <form action="#" method="POST" enctype="multipart/form-data">
      ...
      <br>
      <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
       <input class="mdl-textfield__input" placeholder="Date" name="DeliveryDate" type="date" id="width">
  ...
  <div class="mdl-textfield mdl-js-textfield">
    ...
    <span class="mdl-textfield__error">Input is not a number!</span>
      ...
      <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored mdl-js-ripple-effect mdl-button--accent" name="BizCards_Order">SUBMIT ORDER</button>
     </form>
    </div>
  </div>
